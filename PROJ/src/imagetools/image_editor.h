...
/** @brief This is the major class of the FlashPhoto application.

 In the model-view-controller paradigm,
 we can think of this class as implementing
...
class ImageEditor {
 public:
  ...
  /** Return this ImageEditor class variable to the PixelBuffer class */
  PixelBuffer *pixel_buffer();

  /** Return the PixelBuffer class variable as ImageEditor */
