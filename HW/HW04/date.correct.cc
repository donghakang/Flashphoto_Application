// Copyright 2018, Editted by Dongha Kang
...
#include <iostream>
#include <string>
#include <cstdio>    // Used for snprintf, converting int to string
...
* elapsed since 00:00:00 Coordinated Universal Time (UTC), Thursday,
* 1 January 1970
*
