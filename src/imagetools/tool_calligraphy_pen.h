...
class ToolCalligraphyPen : public Tool {
 public:
  ...
  /** @brief Calls the name of the tool, calligraphy pen
  @return It returns the name of the tool, "Caligraphy Pen"
  */
  static const std::string name() { return "Caligraphy Pen"; }

  /** @brief Create the mask that is for the calligraphy pen tool.
   For caligraphy pen tool, it will create oval mask.
