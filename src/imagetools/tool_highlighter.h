...
class ToolHighlighter : public Tool {
 public:
  ...
  /** @brief Calls the name of the tool, highlighter
  @return It returns the name of the tool, "Highlighter"
  */
  static const std::string name() { return "Highlighter"; }

  /** @brief Create the mask that is for the highlighter tool.
   For highlighter tool, it will create oval mask.
